...
TOKEN = '6653281529:AAEbXSFAQVndl5VMf33U2X_Ma426GmEkX1s'
...
FORWARD_CHANNEL_ID = -1002163147438
CHANNEL_ID = -1002163147438
error_channel_id = -1002163147438
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/c/1901788425/26277*", parse_mode='Markdown')
    ...
    elif message.text == "UPI ID":
        bot.reply_to(message, "*vampirelive@axl*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Contact @GOKU_VAMPIRE*", parse_mode='Markdown')
    else:
